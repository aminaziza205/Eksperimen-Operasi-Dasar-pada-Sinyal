...
**Nama Mahasiswa:** [akhmad amin aziza]  
...
## Ringkasan Hasil Eksperimen & Kesimpulan
...
- Sifat linieritas terbukti penuh pada sistem linier $T_1(x) = 2x$, sedangkan sistem kuadrat $T_2(x) = x^2$ terbukti non-linier karena gagal memenuhi prinsip superposisi (homogenitas dan additivitas).# Eksperimen-Operasi-Dasar-pada-Sinyal
